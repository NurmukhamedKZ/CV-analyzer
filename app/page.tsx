      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Upload CV</h3>
            <p className="text-gray-600 dark:text-gray-300">Support for PDF and DOCX formats with secure processing</p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-300">Advanced GPT-4 analysis for comprehensive feedback</p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-300">Detailed insights and actionable improvement suggestions</p>
          </div>
        </div>
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Upload CV</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Upload your CV in PDF or DOCX format</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Add Job Description</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Paste the job description you're applying for</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">Our AI analyzes compatibility and provides feedback</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">Receive detailed insights and improvement tips</p>
            </div>
          </div>
        </div>
      </main>
