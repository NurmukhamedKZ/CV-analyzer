    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">CV Analysis Results</h1>
            <div className="inline-flex items-center space-x-4 bg-gray-50 px-8 py-4 rounded-full">
              ...
              <div className="text-left">
                <p className="text-2xl font-semibold text-gray-900">Overall Score</p>
                <p className="text-gray-600">out of 100</p>
              </div>
            </div>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">{result.summary}</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Grammar & Clarity</h2>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Keyword Match</h2>
            </div>
